...
from polymarq_backend.core.utils.transform_errors import handle_and_validate_errors_list, validate_and_transform_errors
...
class ErrorResponse(Response):
    ...
    def generate_error_data(
        ...
        serializer_errors_as_list = self.validate_and_transform_serializer_errors(details)
    ...
    def validate_and_transform_serializer_errors(
        ...
        serializer_errors = validate_and_transform_errors(DEFAULT_ERROR_CODES, details=details)
