...
def distance_between_two_points(lat1=0, lat2=0, lon1=0, lon2=0):
    """
...
def add_count(data: dict | list, count: int, **kwargs) -> dict:  # type: ignore
    return dict(data=data, count=count, **kwargs)
