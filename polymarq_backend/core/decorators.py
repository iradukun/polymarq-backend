...
def client_or_technician_required(function=None):
    ...
    user_is_client = lambda user: user.is_technician and user.is_active and user.is_verified  # type: ignore # noqa: E731, E501
    user_is_technician = lambda user: user.is_client and user.is_active and user.is_verified  # type: ignore # noqa: E731, E501
