...
from polymarq_backend.apps.aws_sns.tasks import send_sns_mobile_push_notification_to_device
from polymarq_backend.core.utils.main import send_sms_using_proxy_server
...
class Sender:
    ...
    def email(self):
        ...
        self.email_from = "Polymarq Notifier <info@polymarq.com>"
    ...
    def push(self):
        return send_sns_mobile_push_notification_to_device(
            device=self.device,
