...
class MaintenanceTests(APITestCase, URLPatternsTestCase):
    @classmethod
    def setUpTestData(cls):
        ...
        Maintenance.objects.create(
            ...
            # Not passing Technician to test ListMaintenanceView
            ...
            location_address="17, lagos street. Nigeria",
            technician_type=TechnicianType.objects.create(title="plumber"),
            frequency="WEEKLY",
            location_longitude=0,
            location_latitude=0,
            duration=1,
        ...
        maintenance_uuid = Maintenance.objects.all().first().uuid
        cls.url = reverse("maintenance:create-maintenance")
        cls.url2 = reverse("maintenance:list-maintenance")
        cls.url3 = reverse("maintenance:get-patch-delete-maintenance", kwargs={"uuid": maintenance_uuid})
    ...
    def test_create_maintenance_with_authorized_user(self):
    ...
    def test_create_maintenance_with_unauthorized_user(self):
        response = self.client.post(self.url, self.data, format="multipart")
    ...
    def test_create_maintenance_with_forbidden_user(self):
        # Login and get access token
        technician_data = {
            "email": "UserTechnician@gmail.com",
            "password": "polymarq",
    ...
    def test_get_maintenance_list_with_authorized_user_technician(self):
        # Login and get access token
        technician_data = {
    ...
    def test_get_maintenance_list_with_authorized_user_client(self):
        # Login and get access token
        client_data = {
            "email": "UserClient@gmail.com",
            "password": "polymarq",
    ...
    def test_get_maintenance_list_with_query_params(self):
        # Login and get access token
        technician_data = {
            "email": "UserTechnican@gmail.com",
            "password": "polymarq",
    ...
    def test_maintenance_list_with_unauthorized_user(self):
        response = self.client.get(self.url2, format="json")
        self.assertEqual(response.status_code, status.HTTP_401_UNAUTHORIZED)
        self.assertEqual(len(response.data), 2)  # check error response
        self.assertEqual(response.data["success"], False)  # check error response
    ...
    def test_get_maintenance_with_authorized_user_technician(self):
        # Login and get access token
        technician_data = {
            "email": "UserTechnican@gmail.com",
            "password": "polymarq",
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(len(response.data), 3)  # check success response
        self.assertEqual(len(response.data["result"]), 18)  # check response data

    def test_get_maintenance_with_authorized_user_client(self):
        # Login and get access token
        client_data = {
            "email": "UserClient@gmail.com",
            "password": "polymarq",
    ...
    def test_maintenance_with_unauthorized_user(self):
        response = self.client.get(self.url3, format="json")
        self.assertEqual(response.status_code, status.HTTP_401_UNAUTHORIZED)
        self.assertEqual(len(response.data), 2)  # check error response
        self.assertEqual(response.data["success"], False)  # check error response
    ...
    def test_update_maintenance_with_authorized_user(self):
        # Login and get access token
        client_data = {
            "email": "UserClient@gmail.com",
            "password": "polymarq",
        ...
        response = self.client.patch(self.url3, {"frequency": "MONTHLY"}, format="multipart")

        self.assertEqual(response.status_code, status.HTTP_202_ACCEPTED)
        self.assertEqual(len(response.data), 3)  # check success response
        self.assertEqual(len(response.data["result"]), 17)  # check response data
        self.assertEqual(response.data["result"]["frequency"], "MONTHLY")  # check update

    def test_update_maintenance_with_forbidden_user(self):
        # Login and get access token
        technician_data = {
            "email": "UserTechnician@gmail.com",
            "password": "polymarq",
    ...
    def test_update_maintenance_with_unauthorized_user(self):
    ...
    def test_delete_maintenance_with_authorized_user(self):
        # Login and get access token
        client_data = {
            "email": "UserClient@gmail.com",
            "password": "polymarq",
    ...
    def test_delete_maintenance_with_forbidden_user(self):
        # Login and get access token
        technician_data = {
            "email": "UserTechnician@gmail.com",
            "password": "polymarq",
    ...
    def test_delete_maintenance_with_unauthorized_user(self):
